...
class ControlTable:
    def __init__(self):
        # EEPROM Area
        self.MODEL_NUMBER_L = Register(0, eeprom=True, size=2)
        ...
        self.CW_ANGLE_LIMIT_L = Register(6, mode='rw', eeprom=True, size=2)
        self.CW_ANGLE_LIMIT_H = Register(7, mode='rw', eeprom=True)
        self.CCW_ANGLE_LIMIT_L = Register(8, mode='rw', eeprom=True, size=2)
        ...
        self.MAX_TORQUE_L = Register(14, mode='rw', eeprom=True, size=2)
        ...
        self.DOWN_CALIBRATION_L = Register(20, eeprom=True, size=2)
        self.DOWN_CALIBRATION_H = Register(21, eeprom=True)
        self.UP_CALIBRATION_L = Register(22, eeprom=True, size=2)
        ...
        self.GOAL_POSITION_L = Register(30, mode='rw', size=2)
        self.GOAL_POSITION_H = Register(31, mode='rw')
        self.MOVING_SPEED_L = Register(32, mode='rw', size=2)
        self.MOVING_SPEED_H = Register(33, mode='rw')
        self.TORQUE_LIMIT_L = Register(34, mode='rw', size=2)
        self.TORQUE_LIMIT_H = Register(35, mode='rw')
        self.PRESENT_POSITION_L = Register(36, size=2)
        self.PRESENT_POSITION_H = Register(37)
        self.PRESENT_SPEED_L = Register(38, size=2)
        self.PRESENT_SPEED_H = Register(39)
        self.PRESENT_LOAD_L = Register(40, size=2)
        ...
        self.PUNCH_L = Register(48, mode='rw', size=2)
        self.PUNCH_H = Register(49, mode='rw')


class Register():
    def __init__(self, address, mode='r', eeprom=False, size=1):
